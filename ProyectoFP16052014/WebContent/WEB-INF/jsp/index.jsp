		...
		<div class="container-fluid negroTransparente" id="wrap">
			...
			<div class="row alineadoVertical">
				...
				<div class="col-xs-8 col-xs-offset-2
							...
							<table>
								...
								<tr>
									<td>
										...
										<input type="text" id="nombre" name="usuario.usuario">
									</td>
								</tr>
								<tr>
									<td>
								...
								<tr>
									<td>
										<input type="text" id="password" name="usuario.password">
									</td>
								</tr>
								<tr>
									<td>
										<button class="btn-lg btn-success"><s:text name="logearse"/></button>
									</td>
								</tr>
							</table>
						</s:form>
					...
					<div class="row">
						<s:text name="hacerRegistro"/><s:a action="registro"><s:text name="registro"/></s:a>
					</div>
					<div class="row">
						<s:actionmessage/>
					</div>
